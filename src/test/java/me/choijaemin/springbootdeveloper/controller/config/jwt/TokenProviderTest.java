package me.choijaemin.springbootdeveloper.controller.config.jwt;

import io.jsonwebtoken.Jwts;
import me.choijaemin.springbootdeveloper.config.jwt.JwtProperties;
import me.choijaemin.springbootdeveloper.config.jwt.TokenProvider;
...
public class TokenProviderTest {
    ...
    @Test
    void generateToken(){
        User testUser = userRepsoitory.save(User.builder()
